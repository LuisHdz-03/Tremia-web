...
import { getOrganizacionUsuariosApi, type OrganizacionUsuario } from '../api/usuarios'
                  ...
                  {loading ? (
                    ...
                    list.map((o) => (
                      <tr key={o.email}>
                        ...
                        <td>
                          <MutedText>{Array.isArray(o.intereses) ? o.intereses.join(', ') : String(o.intereses)}</MutedText>
                        </td>
                        <td>
                          <RowActions>
